...
def reset_state():
    ...
    node3 = PathNode(node_id="n3", path_id="p1", course_id="c3", sequence_order=3, status=NodeStatus.LOCKED)
...
def test_next_node_recommendation():
    ...
    client.post("/nodes/n1/complete", json={"learner_id": "L1", "assessment_score": 90.0, "practical_pass": True})
...
def test_recommendation_is_dependency_aware():
    ...
    node4 = PathNode(node_id="n4", path_id="p1", course_id="c4", sequence_order=4, status=NodeStatus.UNLOCKED)
